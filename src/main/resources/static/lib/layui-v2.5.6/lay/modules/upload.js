    ...
    p.prototype.config = {
        ...
        var n, a = this, l = a.config, r = a.elemFile[0], u = function () {
            ...
            if (a.elemFile.next("." + s).remove(), r.value = "", "object" != typeof t) try {
                t = JSON.parse(t)
            } catch (i) {//文字：请对上传接口返回有效JSON
                return t = {}, a.msg("&#x8bf7;&#x5bf9;&#x4e0a;&#x4f20;&#x63a5;&#x53e3;&#x8fd4;&#x56de;&#x6709;&#x6548json")
            }
        ...
        if (v = 0 === v.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "" : v, 0 !== v.length) {
            switch (l.accept) {
                case"file":
                    if (h && !RegExp("\\w\\.(" + h + ")$", "i").test(escape(v))) return a.msg("&#x9009;&#x62e9;&#x7684;&#x6587;&#x4ef6;&#x4e2d;&#x5305;&#x542b;&#x4e0d;&#x652f;&#x6301;&#x7684;&#x683c;&#x5f0f;"), r.value = "";//文字：选择的文件中包含不支持的格式
                    break;
                case"video":
                    if (!RegExp("\\w\\.(" + (h || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(v))) return a.msg("&#x9009;&#x62e9;&#x7684;&#x89c6;&#x9891;&#x4e2d;&#x5305;&#x542b;&#x4e0d;&#x652f;&#x6301;&#x7684;&#x683c;&#x5f0f;"), r.value = "";//文字：选择的视频中包含不支持的格式
                    break;
                case"audio":
                    if (!RegExp("\\w\\.(" + (h || "mp3|wav|mid") + ")$", "i").test(escape(v))) return a.msg("&#x9009;&#x62e9;&#x7684;&#x97f3;&#x9891;&#x4e2d;&#x5305;&#x542b;&#x4e0d;&#x652f;&#x6301;&#x7684;&#x683c;&#x5f0f;"), r.value = "";//选择的音频中包含不支持的格式
                    break;
                default:
                    if (layui.each(v, function (e, t) {
                        RegExp("\\w\\.(" + (h || "jpg|png|gif|bmp|jpeg$") + ")", "i").test(escape(t)) || (n = !0)
                    }), n) return a.msg("&#x9009;&#x62e9;&#x7684;&#x56fe;&#x7247;&#x4e2d;&#x5305;&#x542b;&#x4e0d;&#x652f;&#x6301;&#x7684;&#x683c;&#x5f0f;"), r.value = ""//选择的图片中包含不支持的格式
            }
            ...
            }(), l.number && a.fileLength > l.number) return a.msg("&#x540c;&#x65f6;&#x6700;&#x591a;&#x53ea;&#x80fd;&#x4e0a;&#x4f20;&#x7684;&#x6570;&#x91cf;&#x4e3a;：" + l.number);//同时最多只能上传的数量为
            if (l.size > 0 && !(o.ie && o.ie < 10)) {
                ...
                }), F) return a.msg("&#x6587;&#x4ef6;&#x4e0d;&#x80fd;&#x8d85;&#x8fc7;" + F)//文件不能超过
            }
            y()
        }
